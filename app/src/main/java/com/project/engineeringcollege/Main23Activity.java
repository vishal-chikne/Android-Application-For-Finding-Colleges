    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GMAP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url ="https://www.google.com/maps?q=universal+college+of+engineering+bhiwandi&rlz=1C1CHBF_enIN850IN850&biw=1536&bih=706&dpr=1.25&um=1&ie=UTF-8&sa=X&ved=0ahUKEwiH-uazxObiAhVh6nMBHf1xDMMQ_AUIECgB";
        ...
        WEBSITE.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String Web = "https://universalcollegeofengineering.edu.in/";
